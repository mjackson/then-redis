...
[
  ...
  // server
  'bgrewriteaof', 'bgsave', 'client kill', 'client list', 'client getname',
  'client setname', 'config get', 'config set', 'config resetstat', 'dbsize',
  'debug object', 'debug segfault', 'flushall', 'flushdb', 'info', 'lastsave',
